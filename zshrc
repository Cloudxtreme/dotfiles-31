...
plugins=(git colored-man-pages colorize brew npm tmux extract sublime sudo osx web-search zsh-completions history tmuxinator vi-mode z zsh-syntax-highlighting)
